...
#pyinstaller --onefile --icon=favicon.ico --add-data "assets/pixel.ttf;." --add-data "assets/JdLcdRoundedRegular-vXwE.ttf;." --add-data "convertor_logo.png;." --add-data "assets/pixel/folder.png;." --add-data "assets/pixel/file.png;." --add-data "assets/pixel/music.png;." --add-data "assets/pixel/film.png;." --add-data "assets/pixel/img.png;." --add-data "assets/pixel/pdf.png;." --add-data "assets/pixel/exe.png;." --add-data "ffmpeg/ffmpeg.exe;." --add-data "assets/Wind_Loop.wav;." compile.py --noconsole
    ...
    def convert(self, selected, Type, outputname, name):
        try:
            ...
            if selected == 'WIND_TO_MP3':
                wind_sound = os.path.join(sys._MEIPASS, "Wind_Loop.wav")
                WIND_TO_MP3.wind_converter(name, Type, outputname, wind_sound, ffmpeg_path) 
            elif selected == 'BPM_MP3':
                BPM_MP3.BPM_converter(name, Type, outputname, ffmpeg_path)
            elif selected == 'CLOUDS_TO_MP4':
                CLOUDS_TO_MP4.CLOUDS_converter(name, Type, ffmpeg_path)
            elif selected == 'RGB_MP4':
                RGB_MP4.RGB_converter(name, Type, outputname, ffmpeg_path)
                ...
                TEXT_TO_MP4.MP4_converter(name, Type, color, outputname, font_path, ffmpeg_path, COLOR_PICKT)
...
class Converter:
    ...
    def convert(self, selected, Type, outputname, name):
        ...
        try:  
            ...
            if selected == 'WIND_TO_MP3':
                wind_sound = os.path.join(sys._MEIPASS, "Wind_Loop.wav")
                copy = WIND_TO_MP3.wind_converter(name, Type, outputname, wind_sound, ffmpeg_path) 
            elif selected == 'BPM_MP3':
                ...
                color = '#{:02x}{:02x}{:02x}'.format(selected_color.r, selected_color.g, selected_color.b)
                font_path = os.path.join(sys._MEIPASS, "JdLcdRoundedRegular-vXwE.ttf")
                copy = TEXT_TO_MP4.MP4_converter(name, Type, color, outputname, font_path, ffmpeg_path, COLOR_PICKT)
